...
<html lang="en">
  ...
  <body class="app-filemgr">
                        ...
                        ?>
                          <li class="list-group-item d-flex pd-sm-x-20">
                            ...
                            <div class="mg-l-auto text-right">
                              <a href="#" onclick="viewDetails(<?php echo $row[0]; ?>,'<?php echo $row[1]; ?>','<?php echo $row[2] ." ".$row[3] ; ?>','<?php echo $row[4]; ?>','<?php echo $row[5]; ?>','<?php echo $row[7] ?>')"><span>View Details</span></a>
                              <br>
                              <small class="tx-12
                                <?php
                                  if ($row[7] == "Pending") {
    ...
    <script>
      ...
      function viewDetails(id,walletID,name,mobile,address,status) {
        current_id = id;
